...
- [podium-mcp](https://github.com/hoainho/podium-mcp) - MCP server for Android device automation. adb gestures, uiautomator hierarchy, WebView DOM + network capture, and canvas/WebGL automation. Single stdio endpoint for AI agents.
