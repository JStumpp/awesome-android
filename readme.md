...
- [Off Grid](https://github.com/alichherawalla/off-grid-mobile) - On-device AI suite for Android & iOS. Run LLMs (Llama, Qwen, Gemma, Phi), Stable Diffusion, vision AI, and Whisper — all offline with zero data leaving the device.
