...
- [ATM-EditText](https://github.com/dinukapj/ATM-EditText) - Allows you to add an auto currency-formatting EditText with the added capability of cuztomizing currency, delimeter, spacing and auto-comma separations
