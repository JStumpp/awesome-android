...
- [AndroidX (Jetpack) releae notes for GitHub](https://github.com/mahozad/androidx-release-notes) - Get AndroidX release notes and changelog in your GitHub notifications.
