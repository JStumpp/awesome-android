...
- [vgo](https://github.com/jzbrooks/vgo) - A tool and Gradle plugin for optimizing vector artwork files (including vector drawables) to help ensure your vector artwork is represented compactly without compromising quality.
